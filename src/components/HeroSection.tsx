    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div>
          <Link
            href="/contact"
            className="text-lg md:text-xl py-6 md:py-7 px-20 md:px-22 rounded-md cursor-pointer font-urbanist mx-4 transition-colors duration-300 hover:bg-blue-700 mb-4 lg:mb-0 relative overflow-hidden inline-block"
          ...
          <Link
            href="/#services"
            className="text-lg md:text-xl py-6 md:py-7 px-20 md:px-22 rounded-md cursor-pointer font-urbanist mx-4 transition-colors border border-white duration-300 relative overflow-hidden inline-block"
            style={{  color: 'var(--color-secondary)' }}
